...
## Практические работы
  ...
  - Практическая работа 4. [Оконные функции для анализа данных](/practice/pr-04.pdf).Практическая работа
  - Практическая работа 5.  [SQL для подготовки данных](/practice/).

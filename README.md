...
## Практические работы
  ...
  - Практическая работа 7.  [Робота с внешними приложениями](/practice/pr-7-2024.pdf). Результаты(отчет и дамп с расширением `sql`) представить в Gogs до `15.20 04.04.2024`.

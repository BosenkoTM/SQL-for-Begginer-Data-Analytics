...
## Практические работы
  ...
  - Практическая работа 7.  [Работа с внешними приложениями](practice/pr_07/readme.md).
  ...
  - Практическая работа 13.  [План запроса](/practice/pr-13.pdf).
  - Практическая работа 14.  [Функции и триггеры](/practice/pr-14.pdf).

## Самостоятельные работы

Самостоятельная работа `1`. [Условие задания]().

Самостоятельная работа `2`. [Робота с внешними приложениями](). Результаты представить в виде:
...
Самостоятельная работа `3`. [Условие задания]()

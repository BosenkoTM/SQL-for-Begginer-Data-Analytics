...
## Практические работы
  ...
  - Практическая работа 7.  [Робота с внешними приложениями](/practice/pr-7-2024.pdf). Результаты представить в `Gogs` до `15.20 04.04.2024`в виде:
    - файл с решением задания 1.-5 в формате.ipynb;

...
В заданиях 2-3 должно быть не менее 5 запросов для предметной области, согласно [индивидуального варианта](/practice/sam_3_function/ind_zadanie_2024.pdf). Каждый скрипт должен включать один из следующих элементов:
...
Полученные результаты выгрузить в [Moodle](http://95.31.0.249/moodle/mod/assign/view.php?id=1322), которые представлены следующими файлами:
1. `DDL-скрипт` созданной бд с расширением `sql`;
2.  Скрипт-файл выполненных запросов.

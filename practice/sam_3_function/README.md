...
В заданиях 2-3 должно быть не менее 5 запросов для предметной области, согласно индивидуального варианта. Каждый скрипт должен включать один из следующих элементов:

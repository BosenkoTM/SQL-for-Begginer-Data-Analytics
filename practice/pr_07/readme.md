# Практическая работа 7. Импорт и экспорт данных в SQL

## Цель:
Цель данной практической работы — научиться импортировать и экспортировать данные в базу данных SQL. Работа включает в себя загрузку данных из внешних источников в таблицы базы данных, а также экспорт данных из базы данных в различные форматы, такие как CSV и Excel. Студенты научатся работать с внешними данными, преобразовывать их в нужный формат и интегрировать с существующими таблицами в базе данных.

## Задачи:
1. **Импорт данных в SQL:**
   - Научиться импортировать данные из CSV, Excel или других внешних файлов в таблицы базы данных SQL.
...
2. **Экспорт данных из SQL:**
   - Изучить методы экспорта данных из базы данных SQL в файлы формата CSV, Excel и другие.
...
3. **Работа с внешними источниками данных:**
   - Овладеть навыками подключения к внешним источникам данных (например, API, файлы JSON, CSV и другие форматы).
